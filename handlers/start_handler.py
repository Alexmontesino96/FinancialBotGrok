...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Mensaje inicial con opciones para crear o unirse a una familia, o manejar enlaces profundos."""
...
async def start_create_family(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Inicia el flujo para crear una familia o redirige al flujo de unirse."""
